...
function translation(binding) {
  ...
  var additional = {
    ...
    "move window": "action_moveWindow",
    "resize window": "action_resizeWindow",
    "restore window width": "action_restoreWindowWidth",
    "save window width": "action_saveWindowWidth",
    "mute": "action_mute",
    "mute microphone": "action_muteMicrophone",
    "next track": "action_nextTrack",
    "previous track": "action_previousTrack",
    "pause": "action_pause",
    "play": "action_play",
    "toggle touchpad": "action_toggleTouchpad",
    "disable touchpad": "action_disableTouchpad",
    "enable touchpad": "action_enableTouchpad",
    "color picker": "action_colorPicker",
    "eject media": "action_ejectMedia",
    "keyboard backlight cycle": "action_keyboardBacklightCycle",
    "keyboard brightness up": "action_keyboardBrightnessUp",
    "keyboard brightness down": "action_keyboardBrightnessDown",
    "extract text (ocr) from screenshot": "action_extractTextOcr",
    "toggle locking on idle": "action_toggleLockingOnIdle",
    "toggle silencing notifications": "action_toggleSilencingNotifications",
    "scroll active workspace forward": "action_scrollWorkspaceForward",
    "scroll active workspace backward": "action_scrollWorkspaceBackward",
    "switch audio output": "action_switchAudioOutput",
    "switch media source": "action_switchMediaSource",
    "move workspace to left monitor": "action_moveWorkspaceLeftMonitor",
    "move workspace to right monitor": "action_moveWorkspaceRightMonitor",
    "move workspace to up monitor": "action_moveWorkspaceUpMonitor",
    "move workspace to down monitor": "action_moveWorkspaceDownMonitor",
    "make webcam overlay larger": "action_webcamOverlayLarger",
    "make webcam overlay smaller": "action_webcamOverlaySmaller",
    "volume up": "action_volumeUp",
    "volume up precise": "action_volumeUp",
    "volume down": "action_volumeDown",
    "volume down precise": "action_volumeDown",
    "brightness up": "action_brightnessUp",
    "brightness up precise": "action_brightnessUp",
    "brightness down": "action_brightnessDown",
    "brightness down precise": "action_brightnessDown",
    "screenshot": "action_screenshot",
    "screenrecording": "action_screenRecording",
    "screen recording display": "action_screenRecordingDisplay",
    "screen recording display (apple top row)": "action_screenRecordingDisplay",
    "screenshot region (apple top row)": "action_screenshotRegion",
    "screenshot window (apple top row)": "action_screenshotWindow",
    "screenshot display (apple top row)": "action_screenshotDisplay",
    "emojis": "action_emoji"
  }
  ...
  match = description.match(/^bar panel (\d+)$/)
  if (match) return { key: "action_barPanel", values: { index: match[1] } }
