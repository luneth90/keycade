...
var ALT = 8
var SUPER = 64
// SHIFT is deliberately absent. It is already expressed by the character the
// key produced: typing "G" means Shift was down, and comparing it again would
// reject every capital letter on a keyboard that reaches it any other way.
...
function normalizedStep(value) {
  ...
  var mods = Number(value.mods || 0) & MODIFIER_MASK
  var named = canonicalName(value.named)
  if (named) return { mods: mods, named: named, text: "" }
