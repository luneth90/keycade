...
function resolvedOptions(id, detected) {
  ...
  var prefixes = []
  if (result.prefix) prefixes.push(result.prefix)
  if (result.prefix2 && !sameOption(result.prefix, result.prefix2)) prefixes.push(result.prefix2)
  ...
  result.prefix = prefixes.length ? prefixes[0] : "C-b"
