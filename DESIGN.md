...
状态：设计版本 v0.5.10　·　对应插件版本 0.2.10　·　品牌副标题已正式加入界面

## 0. 版本记录

| 文档版本 | 插件版本 | 日期 | 主要变化 |
|---|---|---|---|
| **v0.5.10** | **0.2.10** | 2026-09-02 | 保留 Keycade 品牌，增加双语副标题“Shortcut Recall Arcade / 快捷键记忆训练机” |
...
文档中的 0.2.10 表示本轮产品设计和插件发布版本。源码、测试和安装包必须保持
...
```json
{
  ...
  "version": "0.2.10",
  "author": "<username>",
  "description": "Keycade — a shortcut recall arcade for Omarchy and Hyprland.",
  "kinds": ["overlay"],
  "keepLoaded": true,
  "entryPoints": {
    "overlay": "Keycade.qml"
...
| **0.2.10** | 增加品牌副标题并调整标题层级 | 英文显示 Shortcut Recall Arcade，中文显示快捷键记忆训练机；副标题位于 KEYCADE 主标题下方 |
